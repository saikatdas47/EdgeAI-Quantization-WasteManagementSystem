...
OUT_DIR        = "/Users/saikatdas/Desktop/IOT BrenchMark/ConvertTflite/New2_MobileNetV3Small"

BATCH_SIZE  = 32
REP_BATCHES = 15
SEED        = 42

# EfficientNetB0 usually uses preprocess_input => [-1, 1]
REP_NORM_MODE = "raw_255"   # "minus1_1" | "0_1" | "raw_255"
# ============================================================
...
# IMPORTANT RULE:
# - representative_dataset generator MUST yield float32 tensors
...
# FULL INT8: request integer-only ops + int8 IO
...
meta = {
    ...
    "classes": class_names,
    "io_types": {
        "fp32":   {"in": "float32", "out": "float32"},
        "fp16":   {"in": "float32", "out": "float32"},
        "drq":    {"in": "float32", "out": "float32"},
        "int8_hybrid_floatio": {"in": "float32", "out": "float32"},
        "int8_full_int8io":    {"in": "int8",    "out": "int8"},
    },
    "outputs": {
